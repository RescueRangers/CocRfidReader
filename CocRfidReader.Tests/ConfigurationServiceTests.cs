...
namespace CocRfidReader.Tests
{
    public class ConfigurationServiceTests
    {
        ...
        public void Setup()
        {
            ...
            serviceCollection.AddSingleton<ILogger<ConfigurationService>>(mockLogger.Object)
                .AddSingleton<ConfigurationService>(new ConfigurationService(mockLogger.Object, configurationPath))
        ...
        public async Task TestExternalEditSynchronization()
        {
            ...
            Assert.That(initialConfig.Antena1Power, Is.EqualTo(20));
            ...
            var index = lines.FindIndex(s => s.StartsWith("  \"antena1Power\": 20,"));
